...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/server/am/ActivityStackSupervisor$LimitPowerConfig;,
...
.field static final CPU_MASK:I = 0x2
...
.field static final FPS_MASK:I = 0x1
...
.field private static final HOTPLUG_KTM_NODE:Ljava/lang/String; = "/sys/module/msm_thermal/core_control/cpus_offlined"
...
.field private static final LIMIT_CPU_LIST:Ljava/lang/String; = "/system/etc/pmlist.config"
...
.field private static final MAX_CPU_FREQ:J = 0x16da00L

.field static final MAX_TIMEOUT_HALT_ACTIVITY_RESUMING:I = 0xbb8

.field private static final MIN_CPU_FREQ:J = 0x10fe00L

.field private static final OFFLINE_MASK_123:I = 0xe
...
.field private static final mControlCPU_limit:Ljava/lang/String; = "/sys/devices/system/cpu/cpu0/cpufreq/scaling_max_freq"

.field static final mIsEnableCPULimit:Z = false

.field static final mIsEnableReduceFps:Z = true

.field static mLimitPowerConfigList:Ljava/util/HashMap;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/server/am/ActivityStackSupervisor;->mLimitPowerConfigList:Ljava/util/HashMap;
...
.method public constructor <init>(Lcom/android/server/am/ActivityManagerService;)V
    ...
    .line 2843
    iput v2, p0, Lcom/android/server/am/ActivityStackSupervisor;->mLastFps:I

    .line 2844
    const-wide/16 v0, 0x0

    iput-wide v0, p0, Lcom/android/server/am/ActivityStackSupervisor;->mLastCpuFreq:J
...
.method private copyCpuList(Ljava/lang/String;Ljava/lang/String;)V
    .locals 12
    .param p1, "fileFromName"    # Ljava/lang/String;
    .param p2, "fileToName"    # Ljava/lang/String;
    ...
    const-string v10, "copyCpuList begin"
    ...
    const-string v10, "copyCpuList occurs error: "

    invoke-static {v9, v10, v3}, Landroid/util/Slog;->d(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    :try_end_3
    ...
    :cond_4
    :goto_4
    sget-boolean v9, Lcom/android/server/am/ActivityManagerService;->DEBUG_TASKS:Z

    if-eqz v9, :cond_0

    const-string v9, "ActivityManager"

    const-string v10, "copyCpuList finish"
...
.method private handleCpuLimit(Ljava/lang/String;Lcom/android/server/am/ActivityStackSupervisor$LimitPowerConfig;)V
    .locals 6
    .param p1, "pkg"    # Ljava/lang/String;
    .param p2, "config"    # Lcom/android/server/am/ActivityStackSupervisor$LimitPowerConfig;

    .prologue
    .line 2894
    const-wide/32 v0, 0x16da00
    ...
    .line 2897
    .local v2, "offline":Z
    iget v3, p2, Lcom/android/server/am/ActivityStackSupervisor$LimitPowerConfig;->mask:I
    ...
    .line 2899
    const-wide/32 v0, 0x10fe00

    .line 2902
    :cond_0
    iget-wide v4, p0, Lcom/android/server/am/ActivityStackSupervisor;->mLastCpuFreq:J
    ...
    const-string v4, "/sys/module/msm_thermal/core_control/cpus_offlined"

    invoke-virtual {p0, v3, v4}, Lcom/android/server/am/ActivityStackSupervisor;->wirteSysFile(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    const-string v5, "Set total freq: "
...
.method private handleFpsMap(Ljava/lang/String;Lcom/android/server/am/ActivityStackSupervisor$LimitPowerConfig;)V
    .locals 4
    .param p1, "pkg"    # Ljava/lang/String;
    .param p2, "config"    # Lcom/android/server/am/ActivityStackSupervisor$LimitPowerConfig;
    ...
    .line 2918
    .local v0, "fps":I
    iget v1, p2, Lcom/android/server/am/ActivityStackSupervisor$LimitPowerConfig;->mask:I
    ...
    .line 2919
    iget v0, p2, Lcom/android/server/am/ActivityStackSupervisor$LimitPowerConfig;->mFps:I

    .line 2921
    :cond_0
    iget v1, p0, Lcom/android/server/am/ActivityStackSupervisor;->mLastFps:I

    if-eq v0, v1, :cond_1

    .line 2922
    invoke-static {v0}, Landroid/view/Choreographer;->setVsyncType(I)V
    ...
    .line 2924
    iput v0, p0, Lcom/android/server/am/ActivityStackSupervisor;->mLastFps:I
...
.method private handleLimitPowerLenovo(Ljava/lang/String;)V
    .locals 5
    .param p1, "pkgName"    # Ljava/lang/String;

    .prologue
    .line 2860
    sget-object v4, Lcom/android/server/am/ActivityStackSupervisor;->mLimitPowerConfigList:Ljava/util/HashMap;
    ...
    check-cast v0, Lcom/android/server/am/ActivityStackSupervisor$LimitPowerConfig;

    .line 2865
    .local v0, "config":Lcom/android/server/am/ActivityStackSupervisor$LimitPowerConfig;
    invoke-direct {p0, v3, v0}, Lcom/android/server/am/ActivityStackSupervisor;->handleFpsMap(Ljava/lang/String;Lcom/android/server/am/ActivityStackSupervisor$LimitPowerConfig;)V

    goto :goto_0

    .line 2870
    .end local v0    # "config":Lcom/android/server/am/ActivityStackSupervisor$LimitPowerConfig;
...
.method private splitFileIntoList(Ljava/lang/String;)Ljava/util/List;
    ...
    const-string v8, "CPU List tempString: "
...
.method final activityIdleInternalLocked(Landroid/os/IBinder;ZLandroid/content/res/Configuration;)Lcom/android/server/am/ActivityRecord;
    ...
    invoke-direct {v0, v3}, Lcom/android/server/am/ActivityStackSupervisor;->handleLimitPowerLenovo(Ljava/lang/String;)V
    :try_end_0
...
.method handleActivityPausedForLimitPower()V
    .locals 7
    ...
    .line 2878
    .local v2, "fps":I
    iget v4, p0, Lcom/android/server/am/ActivityStackSupervisor;->mLastFps:I

    if-eq v4, v2, :cond_0

    .line 2879
    invoke-static {v2}, Landroid/view/Choreographer;->setVsyncType(I)V
    ...
    const-string v6, "Limit FPS to default: "
...
.method reportResumedActivityLocked(Lcom/android/server/am/ActivityRecord;)Z
    ...
    invoke-static {v3, v4}, Lcom/lenovo/lcd/LenovoLcdEffectInterface;->reportResumedActivityLocked(Ljava/lang/String;Landroid/content/Context;)V
...
.method public setFpsHashMap()V
    .locals 11

    .prologue
    .line 2932
    :try_start_0
    const-string v8, "/system/etc/pmlist.config"

    invoke-direct {p0, v8}, Lcom/android/server/am/ActivityStackSupervisor;->splitFileIntoList(Ljava/lang/String;)Ljava/util/List;

    move-result-object v3

    .line 2933
    .local v3, "mCpuList":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    sget-boolean v8, Lcom/android/server/am/ActivityManagerService;->DEBUG_TASKS:Z
    ...
    .line 2965
    .end local v3    # "mCpuList":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    :cond_1
    :goto_0
    return-void

    .line 2938
    .restart local v3    # "mCpuList":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    :cond_2
    ...
    .line 2941
    .local v5, "splitstrs":[Ljava/lang/String;
    const/4 v8, 0x0
    ...
    .line 2946
    :cond_4
    sget-object v8, Lcom/android/server/am/ActivityStackSupervisor;->mLimitPowerConfigList:Ljava/util/HashMap;
    ...
    .line 2948
    new-instance v0, Lcom/android/server/am/ActivityStackSupervisor$LimitPowerConfig;

    .end local v0    # "config":Lcom/android/server/am/ActivityStackSupervisor$LimitPowerConfig;
    invoke-direct {v0}, Lcom/android/server/am/ActivityStackSupervisor$LimitPowerConfig;-><init>()V

    .line 2949
    .restart local v0    # "config":Lcom/android/server/am/ActivityStackSupervisor$LimitPowerConfig;
    const/4 v8, 0x0

    iput v8, v0, Lcom/android/server/am/ActivityStackSupervisor$LimitPowerConfig;->mask:I
    ...
    .line 2954
    iget v8, v0, Lcom/android/server/am/ActivityStackSupervisor$LimitPowerConfig;->mask:I
    ...
    iget v10, v0, Lcom/android/server/am/ActivityStackSupervisor$LimitPowerConfig;->mask:I
    ...
    .end local v5    # "splitstrs":[Ljava/lang/String;
    ...
    const-string v9, "read power limit failed"
    ...
    .restart local v5    # "splitstrs":[Ljava/lang/String;
    ...
    iput v8, v0, Lcom/android/server/am/ActivityStackSupervisor$LimitPowerConfig;->mFps:I
...
.method wirteSysFile(Ljava/lang/String;Ljava/lang/String;)Z
    .locals 8
    ...
    const-string v7, "Write Sys File,FilePath: "
    ...
    const-string v6, "wirteSysFile occurs error: "
