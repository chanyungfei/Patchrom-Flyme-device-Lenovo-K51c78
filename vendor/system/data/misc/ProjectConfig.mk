...
#lenovo_sw liaohj modify for evb wcn
...
#lenovo.sw START 20150323 wangsx3 config imgsensor
...
#lenovo.sw START wangsx3 20150928 remove long shutter
#LENOVO_LSHUTTER_SWITCH = yes
#lenovo.sw END wangsx3 20150928 remove long shutter
#lenovo.sw END 20150323 wangsx3 config imgsensor
#lenovo-sw caoyi1 modify for Msensor begin
...
#lenovo-sw caoyi1 modify for Msensor end
CUSTOM_HAL_SENSORS = sensor
#lenovo.sw START 20150320 wangsx3 config imgsensor
...
#lenovo.sw END 20150320 wangsx3 config imgsensor
#lenovo_sw liaohj modify for evb
#lenovo_sw caoyi1 modify for sensor 20150320 begin
CUSTOM_KERNEL_ACCELEROMETER = lsm6ds3
CUSTOM_KERNEL_STEP_COUNTER = lsm6ds3
CUSTOM_KERNEL_SIGNIFICANT_MOTION_SENSOR = lsm6ds3
CUSTOM_KERNEL_TILT_DETECTOR_SENSOR = 
#lenovo_sw caoyi1 modify for sensor 20150320 end
#lenovo_sw liaohj modify for evb
#lenovo_sw caoyi1 modify for sensor 20150320 begin
CUSTOM_KERNEL_ALSPS = epl8801
#lenovo_sw caoyi1 modify for sensor 20150320 end
...
#lenovo_sw liaohj modify for evb
#lenovo_sw caoyi1 modify for sensor 20150320 begin
CUSTOM_KERNEL_GYROSCOPE = lsm6ds3gy
#lenovo_sw caoyi1 modify for sensor 20150320 end
...
#lenovo_sw liaohj modify for evb
#lenovo-sw caoyi1 modify for Msensor begin
CUSTOM_KERNEL_MAGNETOMETER = akm09911-new mxg2320-new
#lenovo-sw caoyi1 modify for Msensor end
#lenovo.sw START 20150320 wangsx3 config imgsensor
...
#lenovo-sw zhouwl,2015-05-13,do not define kernel sound here,pls review in defconfig begin
#CUSTOM_KERNEL_SOUND = amp_6323pmic_spk
CUSTOM_KERNEL_SOUND =
#lenovo-sw zhouwl,2015-05-13,do not define kernel sound here,pls review in defconfig end
...
#Lenovo-sw linyf modify 2015-03-24 15:28 , change for K5 project.
CUSTOM_MODEM = k5_lwg_dsds k5_ltg_dsds k5_md3_irat_cnom
...
#lenovo_sw wuwl10 modify for aal begin
MTK_AAL_SUPPORT = yes
#lenovo_sw wuwl10 modify for aal end
MTK_ACMT_DEBUG = no
...
#lenovo_sw kelw2 edit begin, support ANT feature
MTK_ANT_SUPPORT = yes
#lenovo_sw kelw2 edit end, support ANT feature
MTK_API_CHECK = yes
...
MTK_ATF_SUPPORT = yes
MTK_ATV_CHIP =
#lenovo-sw zhouwl,2015-05-13,disable mtk audio enhancement feature begin
MTK_AUDENH_SUPPORT = no
#lenovo-sw zhouwl,2015-05-13,disable mtk audio enhancement feature end
MTK_AUDIO = yes
...
#lenovo-sw zhouwl,2015-05-13,disable mic inverse begin
MTK_AUDIO_MIC_INVERSE = no
#lenovo-sw zhouwl,2015-05-13,disable mic inverse end
...
#lenovo-sw zhouwl,2015-05-13,disable mtk besloudness,bessurround feature begin
MTK_BESLOUDNESS_SUPPORT = no
MTK_BESSURROUND_SUPPORT = no
#lenovo-sw zhouwl,2015-05-13,disable mtk besloudness,bessurround feature end
...
#lenovo-sw mahj2 add for charging ic at 20150318 Begin
MTK_BQ24296_SUPPORT = yes
#lenovo-sw mahj2 add for charging ic at 20150318 End
...
#lenovo-sw chenll4 remove the BLEMANAGER begain
MTK_BT_BLE_MANAGER_SUPPORT = no
#lenovo-sw chenll4 remove the BLEMANAGER end
#lenovo_sw liaohj modify for evb wcn
...
MTK_BT_SUPPORT = yes
MTK_BUILD_VERNO = ALPS.L1.MP3.V2.21_LENOVO6753.66T.L1_P186
MTK_BWC_SUPPORT = yes
MTK_C2K_SUPPORT = yes
...
#lenovo.sw START wangsx3 add for K5
MTK_CAM_ZSDHDR_SUPPORT = yes
#lenovo.sw END wangsx3 add for K5
...
#Lenovo-sw linyf modify 2015-08-18 15:28 , disable DRM func.
#MTK_DRM_APP = yes
MTK_DRM_APP = no
...
MTK_DT_SUPPORT = no
#Lenovo-sw zhouwl,2015-07-04,enable this option for stereo record
...
MTK_FIRST_MD = 1
#Lenovo-sw linyf modify 2015-07-28 15:28 , change for K5 project.
MTK_FLIGHT_MODE_POWER_OFF_MD = yes
MTK_FLV_PLAYBACK_SUPPORT = yes
#lenovo-sw fangzf modify 2015-05-13
MTK_FMRADIO_APP = no
...
#lenovo_sw liaohj modify for evb wcn
#lenovo-sw chenll4 remove the FMTransmitter begain
MTK_FM_TX_SUPPORT = no
#lenovo-sw chenll4 remove the FMTransmitter end
...
MTK_IMS_SUPPORT = no
#Lenovo-sw zhouwl,2015-07-04,turn dual mic,should enable below two options
...
MTK_MAV_SUPPORT = yes
#Lenovo-sw linyf modify 2015-03-24 15:28 begin, change for K5 project.
MTK_MD1_SUPPORT = 6
MTK_MD2_SUPPORT = 4
MTK_MD3_SUPPORT = 2
MTK_MD5_SUPPORT = 5
...
#lenovo_sw wuwl10 20150817 modify for pq begin
MTK_MIRAVISION_IMAGE_DC_SUPPORT = yes
MTK_MIRAVISION_SETTING_SUPPORT = no
#lenovo_sw wuwl10 20150817 modify for pq end
...
#lenovo_sw lumy1 modify for evt
...
#lenovo-sw kelw2 add for updating OMA to 3.2.1 verson
...
#Lenovo-sw quebs2 modified 20150617 begin, disable default MTK permission control
#MTK_PERMISSION_CONTROL = yes
MTK_PERMISSION_CONTROL = no
#Lenovo-sw quebs2 modified 20150617 end, disable default MTK permission control
#lenovo-sw mahj2 modify for opening persist Begin
MTK_PERSIST_PARTITION_SUPPORT = yes
#lenovo-sw mahj2 modify for opening persist End
...
#lenovo-sw wuzb1 2015-07-31 disable protection lock app
...
#lenovo_sw liaohj modify for evb
#lenovo-sw caoyi1 modify for sensor 20150320 begin
MTK_SENSOR_SUPPORT = yes
#lenovo-sw caoyi1 modify for sensor 20150320 end
...
#Lenovo-sw linyf modify 2015-03-24 15:28 end.
...
MTK_VLW_APP = yes
#Lenovo-sw linyf modify 2015-06-12 15:28 , change for K5 project begin.
...
#Lenovo-sw linyf modify 2015-06-12 15:28 , end.
...
#Lenovo-sw chengjr1 modify 2015-10-20, change for K5 open project.
MTK_CT4GREG_APP = yes
MTK_DEVREG_APP = yes
#Lenovo-sw chengjr1 modify 2015-10-20 end.
...
######### LCD ###############################################################
#lenovo-sw wuwl10 20150610 add for multi index color begin
LENOVO_PQ_MULTI = yes
#lenovo-sw wuwl10 20150610 add for multi index color end
######### Audio Module #################
LENOVO_SND_FLORIDA = yes
######### Charging #####################
...
#begin, [neusoft] [zhuzhen] [add] [cp teei_daemon to system/bin] [2015/04/29]
TEEI_SUPPORT = yes
#end, [neusoft] [zhuzhen] [add] [cp teei_daemon to system/bin] [2015/04/29]

#begin lenovo-sw zhucc2 add for sd card switch
LENOVO_SHARED_SDCARD = yes
#end   lenovo-sw zhucc2 add for sd card swicth

#CREATE_PROJECT_INFO=20150615165043

#lenovo-sw songwei4 add for flawless support 2015-5-19.
LENOVO_FLAWLESS_SUPPORTED = yes
#lenovo-sw songwei4 add for flawless support.

#lenovo-sw heww3 add begin
