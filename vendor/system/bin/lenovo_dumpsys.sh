...
if [ -d $LOGPATH ]; then
	...
	dumpsys activity activities | busybox tee >> $LOGFILE

	echo "\n ================== dumpsys window -a:\n" >> $LOGFILE
	dumpsys window -a | busybox tee >> $LOGFILE

	echo "\n ================== dumpsys SurfaceFlinger:\n" >> $LOGFILE
	dumpsys SurfaceFlinger | busybox tee >> $LOGFILE

	echo "\n ================== dumpsys activity:\n" >> $LOGFILE
	dumpsys activity | busybox tee >> $LOGFILE
