...
# static fields
.field private static final CHECKTEMPURARUREDUMINRATION:I = 0xbb8

.field private static final CPUBOOSTDUMINRATION:I = 0x7d0

.field private static final CPUBOOSTDURATION:I = 0xdac
...
.field private mLastCheckTempuratureTime:J
...
.field private mTouchBoostmode:I
...
.field private sTouchEvenetBoostCpuList:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List",
            "<",
...
.method public constructor <init>(Landroid/content/Context;Landroid/view/Display;)V
    ...
    .line 446
    iput-boolean v4, p0, Landroid/view/ViewRootImpl;->mIsTargetPackage:Z
    ...
    .line 7983
    iput v4, p0, Landroid/view/ViewRootImpl;->mFrame:I
    ...
    iput-object v0, p0, Landroid/view/ViewRootImpl;->sTouchEvenetBoostCpuList:Ljava/util/List;

    .line 7993
    iput v5, p0, Landroid/view/ViewRootImpl;->mTouchBoostmode:I

    .line 7994
    iput-object v1, p0, Landroid/view/ViewRootImpl;->mPm:Landroid/os/PowerManager;

    .line 7995
    const-wide/16 v2, 0x0

    iput-wide v2, p0, Landroid/view/ViewRootImpl;->mLastBoostTime:J

    .line 7998
    const-wide/16 v2, 0x0

    iput-wide v2, p0, Landroid/view/ViewRootImpl;->mLastCheckTempuratureTime:J
    ...
    .line 510
    :cond_1
    invoke-direct {p0}, Landroid/view/ViewRootImpl;->initTouchEventBoostCpuList()V
...
.method static synthetic access$1700(Landroid/view/ViewRootImpl;)Z
    ...
    .prologue
    .line 115
    invoke-direct {p0}, Landroid/view/ViewRootImpl;->checkNeedBoostCpu()Z
...
.method static synthetic access$1800(Landroid/view/ViewRootImpl;)V
    .locals 0
    .param p0, "x0"    # Landroid/view/ViewRootImpl;

    .prologue
    .line 115
    invoke-direct {p0}, Landroid/view/ViewRootImpl;->boostCpu()V
...
.method private addPkgNametoBoostCpuList(Ljava/lang/String;)Z
    .locals 2
    .param p1, "pkgname"    # Ljava/lang/String;

    .prologue
    .line 8024
    iget-object v1, p0, Landroid/view/ViewRootImpl;->sTouchEvenetBoostCpuList:Ljava/util/List;

    monitor-enter v1

    .line 8025
    :try_start_0
    invoke-direct {p0, p1}, Landroid/view/ViewRootImpl;->checkPkgNameInBoostCpuList(Ljava/lang/String;)Z
    ...
    .line 8026
    iget-object v0, p0, Landroid/view/ViewRootImpl;->sTouchEvenetBoostCpuList:Ljava/util/List;
    ...
    iput v0, p0, Landroid/view/ViewRootImpl;->mTouchBoostmode:I
...
.method private boostCpu()V
    ...
    .prologue
    .line 8101
    iget-object v0, p0, Landroid/view/ViewRootImpl;->mPm:Landroid/os/PowerManager;
    ...
    iput-object v0, p0, Landroid/view/ViewRootImpl;->mPm:Landroid/os/PowerManager;
    ...
    invoke-virtual {v0, v1}, Landroid/os/PowerManager;->boostMax(I)V
...
.method private checkNeedBoostCpu()Z
    .locals 8
    ...
    .line 8057
    .local v2, "curtime":J
    iget-wide v4, p0, Landroid/view/ViewRootImpl;->mLastCheckTempuratureTime:J
    ...
    .line 8058
    const-string v4, "persist.perf.boost_touch"

    iget v5, p0, Landroid/view/ViewRootImpl;->mTouchBoostmode:I
    ...
    .line 8062
    .end local v0    # "boostmode":I
    :cond_0
    invoke-direct {p0}, Landroid/view/ViewRootImpl;->isNeedBoostCpuPacakge()Z
    ...
    .line 8066
    :cond_2
    iget-wide v4, p0, Landroid/view/ViewRootImpl;->mLastBoostTime:J
...
.method private checkPkgNameInBoostCpuList(Ljava/lang/String;)Z
    .locals 1
    .param p1, "pkgname"    # Ljava/lang/String;
...
.method private initTouchEventBoostCpuList()V
    .locals 0
...
.method private isNeedBoostCpuPacakge()Z
    .locals 5
    ...
    .line 8080
    iget v0, p0, Landroid/view/ViewRootImpl;->mTouchBoostmode:I
    ...
    invoke-direct {p0, v3}, Landroid/view/ViewRootImpl;->checkPkgNameInBoostCpuList(Ljava/lang/String;)Z
    ...
    .line 8088
    iput v4, p0, Landroid/view/ViewRootImpl;->mTouchBoostmode:I
    ...
    .line 8091
    :cond_3
    iput v2, p0, Landroid/view/ViewRootImpl;->mTouchBoostmode:I
...
.method private removePkgNamefromBoostCpuList(Ljava/lang/String;)Z
    .locals 2
    .param p1, "pkgname"    # Ljava/lang/String;
...
.method doProcessInputEvents()V
    ...
    iget-object v2, v1, Landroid/view/ViewRootImpl$QueuedInputEvent;->mNext:Landroid/view/ViewRootImpl$QueuedInputEvent;
    ...
    .line 6431
    iput-object v6, p0, Landroid/view/ViewRootImpl;->mPendingInputEventTail:Landroid/view/ViewRootImpl$QueuedInputEvent;

    .line 6433
    :cond_0
    iput-object v6, v1, Landroid/view/ViewRootImpl$QueuedInputEvent;->mNext:Landroid/view/ViewRootImpl$QueuedInputEvent;
    ...
    .line 6442
    const-string v2, "3 1: Process input event"
    ...
    const-string v4, "doProcessInputEvents "
    ...
    const-string v4, "doProcessInputEvents: mCurrentInputEvent = "
    ...
    iput-boolean v2, p0, Landroid/view/ViewRootImpl;->mProcessInputEventsScheduled:Z
