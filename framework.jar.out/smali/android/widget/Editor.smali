...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Landroid/widget/Editor$DelayShowOrHideActionPopupWindowThread;,
...
.field private static final INVALID_CURSOR_OFFSET:I = -0x1

.field private static final TAG:Ljava/lang/String; = "Editor"

.field private static final TEMP_POSITION:[F

.field private static isLastEventCutOrCopy:Z

.field private static isTextJustChanged:Z
...
.field private isActionPopupWindowShowing:Z

.field private isCursorMovedSinceLastEvent:Z

.field private isJustGainFocus:Z

.field private isJustShowSoftInput:Z
...
.field private mLastCursorOffset:I
...
.method static constructor <clinit>()V
    ...
    .line 253
    sput-boolean v1, Landroid/widget/Editor;->isTextJustChanged:Z

    .line 254
    sput-boolean v1, Landroid/widget/Editor;->isLastEventCutOrCopy:Z
...
.method constructor <init>(Landroid/widget/TextView;)V
    ...
    iput v0, p0, Landroid/widget/Editor;->SHOW_OR_HIDE_ACTION_MENU:I
    ...
    iput-boolean v1, p0, Landroid/widget/Editor;->isJustGainFocus:Z

    iput-boolean v1, p0, Landroid/widget/Editor;->isCursorMovedSinceLastEvent:Z

    iput-boolean v1, p0, Landroid/widget/Editor;->isActionPopupWindowShowing:Z

    iput-boolean v1, p0, Landroid/widget/Editor;->isJustShowSoftInput:Z

    const/4 v0, -0x1

    iput v0, p0, Landroid/widget/Editor;->mLastCursorOffset:I
...
.method static synthetic access$100(Landroid/widget/Editor;)V
    .locals 0
    .param p0, "x0"    # Landroid/widget/Editor;

    .prologue
    .line 138
    invoke-direct {p0}, Landroid/widget/Editor;->showOrHideActionPopupWindow()V
...
.method static synthetic access$2000(Landroid/widget/Editor;Landroid/view/View;)[I
    .locals 1
    .param p0, "x0"    # Landroid/widget/Editor;
    ...
    .prologue
    .line 138
    invoke-direct {p0, p1}, Landroid/widget/Editor;->getMeasuredViewSize(Landroid/view/View;)[I
...
.method static synthetic access$2202(Z)Z
    ...
    .prologue
    .line 138
    sput-boolean p0, Landroid/widget/Editor;->isLastEventCutOrCopy:Z
...
.method static synthetic access$2600(Landroid/widget/Editor;I)Z
    .locals 1
    .param p0, "x0"    # Landroid/widget/Editor;
    .param p1, "x1"    # I
...
.method static synthetic access$3402(Landroid/widget/Editor;Landroid/graphics/Rect;)Landroid/graphics/Rect;
    .locals 0
    .param p0, "x0"    # Landroid/widget/Editor;
...
.method static synthetic access$3500(Landroid/widget/Editor;IIZ)V
    .locals 0
    .param p0, "x0"    # Landroid/widget/Editor;
    .param p1, "x1"    # I
    .param p2, "x2"    # I
...
.method static synthetic access$3800(Landroid/widget/Editor;)Z
    ...
    .prologue
    .line 138
    invoke-direct {p0}, Landroid/widget/Editor;->selectCurrentWordFormSingleClick()Z
...
.method static synthetic access$4102(Landroid/widget/Editor;Z)Z
    ...
    .prologue
    .line 138
    iput-boolean p1, p0, Landroid/widget/Editor;->isActionPopupWindowShowing:Z
...
.method static synthetic access$500(Landroid/widget/Editor;)Landroid/os/Handler;
    .locals 1
    .param p0, "x0"    # Landroid/widget/Editor;
...
.method private selectCurrentWordFormSingleClick()Z
    .locals 19
    ...
    .line 839
    .local v8, "minOffsetOrigin":I
    move v6, v8

    .line 841
    .local v6, "maxOffsetOrigin":I
    move-object/from16 v0, p0
    ...
    invoke-interface {v0, v7, v5, v1}, Landroid/text/Spanned;->getSpans(IILjava/lang/Class;)[Ljava/lang/Object;
    ...
    invoke-static {v0, v12, v9}, Landroid/text/Selection;->setSelection(Landroid/text/Spannable;II)V
    ...
    invoke-virtual {v0, v1, v7, v5}, Landroid/text/method/WordIterator;->setCharSequence(Ljava/lang/CharSequence;II)V
    ...
    invoke-virtual {v0, v5}, Landroid/text/method/WordIterator;->getEnd(I)I
...
.method private showOrHideActionPopupWindow()V
    .locals 7
    ...
    iget-boolean v4, p0, Landroid/widget/Editor;->isCursorMovedSinceLastEvent:Z

    if-nez v4, :cond_0

    iget-boolean v4, p0, Landroid/widget/Editor;->isJustGainFocus:Z
    ...
    :goto_0
    iput-boolean v4, p0, Landroid/widget/Editor;->isCursorMovedSinceLastEvent:Z
    ...
    .local v1, "isCursorAtTextEnd":Z
    :goto_1
    sget-boolean v4, Landroid/widget/Editor;->isTextJustChanged:Z
    ...
    :goto_2
    iget-object v4, p0, Landroid/widget/Editor;->mSelectPopupWindow:Landroid/widget/Editor$SelectPopupWindow;

    if-eqz v4, :cond_9

    iget-object v4, p0, Landroid/widget/Editor;->mSelectPopupWindow:Landroid/widget/Editor$SelectPopupWindow;

    invoke-virtual {v4}, Landroid/widget/Editor$SelectPopupWindow;->isShowing()Z
    ...
    .local v2, "isSelectPopupWindowShowing":Z
    :goto_3
    ...
    :cond_1
    :goto_4
    iput-boolean v5, p0, Landroid/widget/Editor;->isJustGainFocus:Z

    sput-boolean v5, Landroid/widget/Editor;->isTextJustChanged:Z

    iput-boolean v5, p0, Landroid/widget/Editor;->isJustShowSoftInput:Z

    return-void

    .end local v1    # "isCursorAtTextEnd":Z
    .end local v2    # "isSelectPopupWindowShowing":Z
    :cond_2
    move v4, v5
    ...
    .restart local v1    # "isCursorAtTextEnd":Z
    :cond_4
    sget-boolean v4, Landroid/widget/Editor;->isLastEventCutOrCopy:Z

    if-eqz v4, :cond_5

    const/4 v3, 0x1

    sput-boolean v5, Landroid/widget/Editor;->isLastEventCutOrCopy:Z

    goto :goto_2

    :cond_5
    iget-boolean v4, p0, Landroid/widget/Editor;->isJustShowSoftInput:Z
    ...
    :cond_7
    iget-boolean v4, p0, Landroid/widget/Editor;->isActionPopupWindowShowing:Z
    ...
    .restart local v2    # "isSelectPopupWindowShowing":Z
    :cond_a
    invoke-virtual {p0}, Landroid/widget/Editor;->getInsertionController()Landroid/widget/Editor$InsertionPointCursorController;

    move-result-object v4

    invoke-virtual {v4}, Landroid/widget/Editor$InsertionPointCursorController;->hideWithActionPopup()V
...
.method onFocusChanged(ZI)V
    ...
    iput-boolean v6, p0, Landroid/widget/Editor;->isJustGainFocus:Z
    ...
    :cond_9
    iput-boolean v7, p0, Landroid/widget/Editor;->isJustGainFocus:Z

    const/4 v5, -0x1

    iput v5, p0, Landroid/widget/Editor;->mLastCursorOffset:I
...
.method onTouchUpEvent(Landroid/view/MotionEvent;)V
    ...
    iget v6, p0, Landroid/widget/Editor;->mLastCursorOffset:I
    ...
    iput v1, p0, Landroid/widget/Editor;->mLastCursorOffset:I
    ...
    new-instance v4, Landroid/widget/Editor$DelayShowOrHideActionPopupWindowThread;

    invoke-direct {v4, p0, v9}, Landroid/widget/Editor$DelayShowOrHideActionPopupWindowThread;-><init>(Landroid/widget/Editor;Landroid/widget/Editor$1;)V

    invoke-virtual {v4}, Landroid/widget/Editor$DelayShowOrHideActionPopupWindowThread;->start()V
...
.method public setJustShowSoftInputAfterTouchEvent(Z)V
    .locals 0
    .param p1, "isJustShowSoftInput"    # Z

    .prologue
    iput-boolean p1, p0, Landroid/widget/Editor;->isJustShowSoftInput:Z
