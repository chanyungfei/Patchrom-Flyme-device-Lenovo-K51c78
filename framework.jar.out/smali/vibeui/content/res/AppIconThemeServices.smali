...
.method private getPrebuildIconsMapStream()Ljava/io/InputStream;
    ...
    :try_start_0
    invoke-direct {p0}, Lvibeui/content/res/AppIconThemeServices;->getIconsFile()Ljava/io/File;
...
.method private getZipIconsMapStream()Ljava/io/InputStream;
    ...
    invoke-virtual {v3, v5}, Lvibeui/content/res/AppIconThemeServices$MyZipFile;->getEntry(Ljava/lang/String;)Ljava/util/zip/ZipEntry;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-virtual {v3, v2}, Lvibeui/content/res/AppIconThemeServices$MyZipFile;->getInputStream(Ljava/util/zip/ZipEntry;)Ljava/io/InputStream;
    :try_end_1
...
.method private final parseIconMapFile()V
    ...
    invoke-direct/range {p0 .. p0}, Lvibeui/content/res/AppIconThemeServices;->getZipIconsMapStream()Ljava/io/InputStream;

    move-result-object v13

    .line 532
    invoke-direct/range {p0 .. p0}, Lvibeui/content/res/AppIconThemeServices;->getPrebuildIconsMapStream()Ljava/io/InputStream;
    ...
    invoke-direct {v0, v13}, Lvibeui/content/res/AppIconThemeServices;->parseIconMapVersion(Ljava/io/InputStream;)I
    ...
    invoke-direct {v0, v8}, Lvibeui/content/res/AppIconThemeServices;->parseIconMapVersion(Ljava/io/InputStream;)I
    ...
    const-string/jumbo v17, "zipVersion = :"
    ...
    const-string/jumbo v17, "prebuildVersion = :"
    ...
    invoke-direct {v0, v3}, Lvibeui/content/res/AppIconThemeServices;->updateThemesMap(Ljava/util/Map;)V
