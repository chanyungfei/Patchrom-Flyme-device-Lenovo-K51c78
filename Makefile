...
#-----------------------------------------------------------------------------
vendor_modify_jars := android.policy com.gsma.services.nfc framework mediatek-framework mediatek-telephony-common services telephony-common wifi-service
...
override_property += \
    ...
    ro.product.model_romer=Lenovo K51c78_Po_Chan
