...
# static fields
.field static final ITEM_LAYOUT:I = 0x7f04004e
...
.method public tryShow()Z
    ...
    .line 135
    new-instance v5, Llenovo/widget/ListPopupWindow;

    iget-object v6, p0, Lcom/lenovo/internal/view/menu/MenuPopupHelper;->mContext:Landroid/content/Context;

    const/4 v7, 0x0

    iget v8, p0, Lcom/lenovo/internal/view/menu/MenuPopupHelper;->mPopupStyleAttr:I

    invoke-direct {v5, v6, v7, v8}, Llenovo/widget/ListPopupWindow;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V

    iput-object v5, p0, Lcom/lenovo/internal/view/menu/MenuPopupHelper;->mPopup:Llenovo/widget/ListPopupWindow;

    .line 136
    iget-object v5, p0, Lcom/lenovo/internal/view/menu/MenuPopupHelper;->mPopup:Llenovo/widget/ListPopupWindow;

    invoke-virtual {v5, p0}, Llenovo/widget/ListPopupWindow;->setOnDismissListener(Llenovo/widget/PopupWindow$OnDismissListener;)V

    .line 137
    iget-object v5, p0, Lcom/lenovo/internal/view/menu/MenuPopupHelper;->mPopup:Llenovo/widget/ListPopupWindow;

    invoke-virtual {v5, p0}, Llenovo/widget/ListPopupWindow;->setOnItemClickListener(Landroid/widget/AdapterView$OnItemClickListener;)V

    .line 138
    iget-object v5, p0, Lcom/lenovo/internal/view/menu/MenuPopupHelper;->mPopup:Llenovo/widget/ListPopupWindow;

    iget-object v6, p0, Lcom/lenovo/internal/view/menu/MenuPopupHelper;->mAdapter:Lcom/lenovo/internal/view/menu/MenuPopupHelper$MenuAdapter;

    invoke-virtual {v5, v6}, Llenovo/widget/ListPopupWindow;->setAdapter(Landroid/widget/ListAdapter;)V

    .line 139
    iget-object v5, p0, Lcom/lenovo/internal/view/menu/MenuPopupHelper;->mPopup:Llenovo/widget/ListPopupWindow;

    invoke-virtual {v5, v4}, Llenovo/widget/ListPopupWindow;->setModal(Z)V
    ...
    .line 146
    iget-object v5, p0, Lcom/lenovo/internal/view/menu/MenuPopupHelper;->mTreeObserver:Landroid/view/ViewTreeObserver;
    ...
    iput-object v5, p0, Lcom/lenovo/internal/view/menu/MenuPopupHelper;->mTreeObserver:Landroid/view/ViewTreeObserver;
    ...
    invoke-virtual {v5, v1}, Llenovo/widget/ListPopupWindow;->setAnchorView(Landroid/view/View;)V

    .line 150
    iget-object v5, p0, Lcom/lenovo/internal/view/menu/MenuPopupHelper;->mPopup:Llenovo/widget/ListPopupWindow;

    iget v6, p0, Lcom/lenovo/internal/view/menu/MenuPopupHelper;->mDropDownGravity:I

    invoke-virtual {v5, v6}, Llenovo/widget/ListPopupWindow;->setDropDownGravity(I)V

    .line 155
    iget-boolean v5, p0, Lcom/lenovo/internal/view/menu/MenuPopupHelper;->mHasContentWidth:Z
    ...
    .line 159
    .local v2, "menuViewWidth":I
    iget-object v5, p0, Lcom/lenovo/internal/view/menu/MenuPopupHelper;->mAnchorView:Landroid/view/View;

    invoke-static {v5}, Lcom/lenovo/internal/widget/ActionBarOverlayLayout;->getActionBarOverlayLayout(Landroid/view/View;)Lcom/lenovo/internal/widget/ActionBarOverlayLayout;
    ...
    iget v5, p0, Lcom/lenovo/internal/view/menu/MenuPopupHelper;->mPopupMaxWidth:I

    :goto_0
    iput v5, p0, Lcom/lenovo/internal/view/menu/MenuPopupHelper;->mContentWidth:I

    .line 165
    iput-boolean v4, p0, Lcom/lenovo/internal/view/menu/MenuPopupHelper;->mHasContentWidth:Z

    .line 168
    .end local v2    # "menuViewWidth":I
    .end local v3    # "view":Landroid/view/View;
    :cond_3
    iget-object v5, p0, Lcom/lenovo/internal/view/menu/MenuPopupHelper;->mPopup:Llenovo/widget/ListPopupWindow;

    iget v6, p0, Lcom/lenovo/internal/view/menu/MenuPopupHelper;->mContentWidth:I

    invoke-virtual {v5, v6}, Llenovo/widget/ListPopupWindow;->setContentWidth(I)V
    ...
    invoke-virtual {v5, v6}, Llenovo/widget/ListPopupWindow;->setInputMethodMode(I)V

    .line 170
    iget-object v5, p0, Lcom/lenovo/internal/view/menu/MenuPopupHelper;->mPopup:Llenovo/widget/ListPopupWindow;

    invoke-virtual {v5}, Llenovo/widget/ListPopupWindow;->show()V

    .line 171
    iget-object v5, p0, Lcom/lenovo/internal/view/menu/MenuPopupHelper;->mPopup:Llenovo/widget/ListPopupWindow;

    invoke-virtual {v5}, Llenovo/widget/ListPopupWindow;->getListView()Landroid/widget/ListView;
    ...
    .restart local v2    # "menuViewWidth":I
