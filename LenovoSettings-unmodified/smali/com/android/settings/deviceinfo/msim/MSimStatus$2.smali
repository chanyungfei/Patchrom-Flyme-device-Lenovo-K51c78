...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    .line 343
    iget-object v4, p0, Lcom/android/settings/deviceinfo/msim/MSimStatus$2;->this$0:Lcom/android/settings/deviceinfo/msim/MSimStatus;

    const-string v5, "phone"

    invoke-virtual {v4, v5}, Lcom/android/settings/deviceinfo/msim/MSimStatus;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;
    ...
    invoke-virtual {v4}, Lcom/android/settings/deviceinfo/msim/MSimStatus;->getApplicationContext()Landroid/content/Context;
    ...
    # invokes: Lcom/android/settings/deviceinfo/msim/MSimStatus;->getSimStatus()Z
    invoke-static {v4}, Lcom/android/settings/deviceinfo/msim/MSimStatus;->access$400(Lcom/android/settings/deviceinfo/msim/MSimStatus;)Z
    ...
    # setter for: Lcom/android/settings/deviceinfo/msim/MSimStatus;->mSimExist:Z
    invoke-static {v4, v7}, Lcom/android/settings/deviceinfo/msim/MSimStatus;->access$502(Lcom/android/settings/deviceinfo/msim/MSimStatus;Z)Z

    .line 368
    iget-object v4, p0, Lcom/android/settings/deviceinfo/msim/MSimStatus$2;->this$0:Lcom/android/settings/deviceinfo/msim/MSimStatus;

    # invokes: Lcom/android/settings/deviceinfo/msim/MSimStatus;->setSimPreference(Z)V
    invoke-static {v4, v7}, Lcom/android/settings/deviceinfo/msim/MSimStatus;->access$600(Lcom/android/settings/deviceinfo/msim/MSimStatus;Z)V
    ...
    # setter for: Lcom/android/settings/deviceinfo/msim/MSimStatus;->mSimExist:Z
    invoke-static {v4, v8}, Lcom/android/settings/deviceinfo/msim/MSimStatus;->access$502(Lcom/android/settings/deviceinfo/msim/MSimStatus;Z)Z

    .line 353
    iget-object v4, p0, Lcom/android/settings/deviceinfo/msim/MSimStatus$2;->this$0:Lcom/android/settings/deviceinfo/msim/MSimStatus;

    # invokes: Lcom/android/settings/deviceinfo/msim/MSimStatus;->setSimPreference(Z)V
    invoke-static {v4, v8}, Lcom/android/settings/deviceinfo/msim/MSimStatus;->access$600(Lcom/android/settings/deviceinfo/msim/MSimStatus;Z)V
