...
.method public constructor <init>(Landroid/content/Context;Ljava/util/List;Lcom/android/settings/accounts/AuthenticatorHelper;)V
    ...
    .line 484
    iput-boolean v2, p0, Lcom/android/settings/dashboard/DashboardSummary$HeaderAdapter;->mIsAirPlaneMode:Z
    ...
    .line 486
    iput-boolean v2, p0, Lcom/android/settings/dashboard/DashboardSummary$HeaderAdapter;->mIsSimNotAvailable:Z

    .line 492
    iput-boolean v2, p0, Lcom/android/settings/dashboard/DashboardSummary$HeaderAdapter;->mIsHeaderIndexChanged:Z
    ...
    .line 569
    :cond_0
    invoke-direct {p0, v2}, Lcom/android/settings/dashboard/DashboardSummary$HeaderAdapter;->updateAirPlaneMode(Z)V

    .line 570
    invoke-direct {p0, v2}, Lcom/android/settings/dashboard/DashboardSummary$HeaderAdapter;->updateSimStatus(Z)V
...
.method public getView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    invoke-direct {v2, v6}, Lcom/android/settings/dashboard/DashboardSummary$HeaderAdapter$HeaderViewHolder;-><init>(Lcom/android/settings/dashboard/DashboardSummary$1;)V
    ...
    .line 636
    :pswitch_1
    iget-object v6, p0, Lcom/android/settings/dashboard/DashboardSummary$HeaderAdapter;->mInflater:Landroid/view/LayoutInflater;
    ...
    iput-object v6, v2, Lcom/android/settings/dashboard/DashboardSummary$HeaderAdapter$HeaderViewHolder;->icon:Landroid/widget/ImageView;
    ...
    iput-object v6, v2, Lcom/android/settings/dashboard/DashboardSummary$HeaderAdapter$HeaderViewHolder;->title:Landroid/widget/TextView;
    ...
    iput-object v6, v2, Lcom/android/settings/dashboard/DashboardSummary$HeaderAdapter$HeaderViewHolder;->switch_:Landroid/widget/Switch;
    ...
    iput-object v6, v2, Lcom/android/settings/dashboard/DashboardSummary$HeaderAdapter$HeaderViewHolder;->status:Landroid/widget/TextView;
    ...
    .line 687
    :pswitch_5
    invoke-direct {p0, v5, v2, v0}, Lcom/android/settings/dashboard/DashboardSummary$HeaderAdapter;->updatePluginHeaderView(Landroid/view/View;Lcom/android/settings/dashboard/DashboardSummary$HeaderAdapter$HeaderViewHolder;Landroid/preference/PreferenceActivity$Header;)Landroid/view/View;
    ...
    .line 703
    iget-object v6, p0, Lcom/android/settings/dashboard/DashboardSummary$HeaderAdapter;->mOPen4GEnabler:Lcom/lenovo/settings/Open4GEnabler;
    ...
    iget-object v7, v2, Lcom/android/settings/dashboard/DashboardSummary$HeaderAdapter$HeaderViewHolder;->switch_:Landroid/widget/Switch;
    ...
    .line 710
    iget-boolean v6, p0, Lcom/android/settings/dashboard/DashboardSummary$HeaderAdapter;->mIsAirPlaneMode:Z
    ...
    .line 712
    invoke-direct {p0, v5, v3}, Lcom/android/settings/dashboard/DashboardSummary$HeaderAdapter;->setEnabledStateOnViews(Landroid/view/View;Z)V
    ...
    invoke-direct {p0, v5, v6}, Lcom/android/settings/dashboard/DashboardSummary$HeaderAdapter;->setEnabledStateOnViews(Landroid/view/View;Z)V
    ...
    .line 726
    iget-object v6, p0, Lcom/android/settings/dashboard/DashboardSummary$HeaderAdapter;->mWifiEnabler:Lcom/android/settings/WiFiStatusEnabler;

    invoke-virtual {v6}, Lcom/android/settings/WiFiStatusEnabler;->getRunningState()Ljava/lang/String;

    move-result-object v4

    .line 732
    :goto_4
    iget-object v6, v2, Lcom/android/settings/dashboard/DashboardSummary$HeaderAdapter$HeaderViewHolder;->status:Landroid/widget/TextView;
    ...
    .line 728
    iget-object v6, p0, Lcom/android/settings/dashboard/DashboardSummary$HeaderAdapter;->mBluetoothEnabler:Lcom/android/settings/bluetooth/BluetoothStatusEnabler;

    invoke-virtual {v6}, Lcom/android/settings/bluetooth/BluetoothStatusEnabler;->getRunningState()Ljava/lang/String;
...
.method public pause()V
    ...
    .line 963
    iget-object v0, p0, Lcom/android/settings/dashboard/DashboardSummary$HeaderAdapter;->mOPen4GEnabler:Lcom/lenovo/settings/Open4GEnabler;
